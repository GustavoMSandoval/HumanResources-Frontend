        ...
        <div className="max-w-md mx-auto flex flex-col justify-center h-screen">
            ...
            <form action={editEmployee} className="flex flex-col border rounded-2xl border-gray-400 bg-gray-50 p-5">
                <div className="relative z-0 w-full mb-5 group">
                    <input id="floating_cpf" className="input-primary" placeholder={employee?.CPF} name="cpf" type="text" min={14} maxLength={14}/>
                ...
                <div className="relative z-0 w-full mb-5 group">
                    <input id="floating_email" className="input-primary" placeholder={employee?.email} name="email" type="text" />
                ...
                <div className="relative z-0 w-full mb-5 group">
                    <input id="floating_name" className="input-primary" placeholder={employee?.name} name="name" type="text" />
